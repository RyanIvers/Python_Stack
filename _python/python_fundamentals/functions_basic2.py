...
# Write a function that accepts a list and creates a new list containing only the values from the original 
...
def values_greater_than_second(list):
    ...
    print(len(newList))
    return newList
print(values_greater_than_second([4,5,7,9,2,9]))
